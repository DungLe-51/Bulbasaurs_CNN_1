...
golden_ofm = read_hex_file('mem_export/golden_maxpool.mem', 256)

print("\n=====================================================")
print("🕵️‍♂️ TÒA ÁN: RTL vs GOLDEN MODEL (MAXPOOL1D - op=2)")
print("=====================================================")
mismatches = np.sum(rtl_ofm != golden_ofm)
if mismatches == 0:
    print("🏆 MISMATCH = 0 — MAXPOOL1D BIT-EXACT PASS 100%!")
else:
